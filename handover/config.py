...
_C.ENV.OFFSCREEN_RENDERER_CAMERA_POSITION = (0.5, -0.4, 1.2)

_C.ENV.OFFSCREEN_RENDERER_CAMERA_TARGET = (0.5, 0.5, 1.2)

# _C.ENV.OFFSCREEN_RENDERER_CAMERA_POSITION = (0, 0, 1) #x (green - table depth), y (red)
